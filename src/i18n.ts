  ...
  it: {
    translation: {
      ...
      "home": {
        ...
        "video_quote": "«Prima ancora di cercare candidati, l'headhunting parte dalla comprensione dell'ambiente in cui la persona sarà chiamata a lavorare. Molte delle difficoltà di inserimento nascono infatti da un mancato allineamento tra la persona e il contesto...»",
      ...
      "about": {
        ...
        "p3": "A questo metodo affianco uno stack tecnico costruito in autonomia. Progetto e metto in produzione web app e dashboard su Google Cloud, integrando analisi automatizzata dei dati HR e strumenti digitali multimodali — dalla sintesi vocale alla generazione video. È infrastruttura di delivery: riduce i tempi operativi, libera tempo per la valutazione delle persone e restituisce a candidati e aziende una reportistica più ricca e accessibile."
      },
      "work_areas": {
        "subtitle": "Perimetro Operativo",
        "title": "Settori e <br /><span className=\"italic text-accent\">Engagement.</span>",
        "p1": "In quasi vent'anni di lavoro nella ricerca di senior professionals, figure manageriali e direttive ho attraversato settori industriali molto diversi tra loro. Questa trasversalità è oggi uno degli asset più consistenti del mio lavoro: mi consente di leggere il mercato delle competenze in modo comparativo, di riconoscere le ricorrenze che attraversano contesti apparentemente distanti, e di costruire sourcing strategies che escono dai perimetri ovvi.",
        "p2": "L'identificazione dei candidati combina hunting diretto, mappature strutturate del mercato di riferimento e una rete professionale costruita negli anni. È un lavoro di analisi: ogni progetto ha una fase di design che inizia dalla ricostruzione di un bacino dove poter identificare profili di competenze interessanti e dallo studio dei percorsi di carriera di chi oggi ricopre ruoli analoghi, nel settore del cliente.",
        "engagements_title": "Selected Engagements",
  ...
  en: {
    translation: {
      ...
      "home": {
        ...
        "video_quote": "«Before searching for candidates, executive search begins with understanding the environment where the individual will be called upon to perform. Most onboarding failures stem from a misalignment between the person and the organizational context...»",
      ...
      "about": {
        ...
        "p3": "I combine this method with an independently built technical stack. I design and deploy web apps and dashboards on Google Cloud, integrating automated HR data analysis and multimodal digital tools — from text-to-speech to video generation. It is delivery infrastructure: it reduces operational time, frees up time for evaluating people, and returns richer and more accessible reporting to candidates and companies."
      },
      "work_areas": {
        ...
        "p2": "Candidate identification combines direct hunting, structured mapping of the target market, and a professional network built over the years. It is an analytical work: every project has a design phase that begins with reconstructing a talent pool to identify interesting skill profiles and studying the career paths of those who currently hold similar roles in the client's sector.",
        "engagements_title": "Selected Engagements",
        "leadership_title": "Leadership <br />Assessment",
