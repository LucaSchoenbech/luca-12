        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          {isEn ? (
            ...
            <article className="prose prose-lg prose-headings:font-display prose-headings:font-medium text-gray-600 font-light leading-relaxed max-w-none">
              ...
              <p>
                C'è però un punto che la teoria dell'utilità di selezione rende controintuitivamente favorevole ai ruoli manageriali: quando il selection ratio è basso — pochi assunti su molti candidati valutati, com'è tipico nell'executive search — e la variabilità di performance tra un manager mediocre e un manager eccellente è alta, anche incrementi modesti di validità producono valore economico rilevante. Tradotto: un segnale che spiega il 13% della varianza è poco come oracolo, ma non è affatto poco come strato aggiuntivo di informazione in una decisione ad alto impatto, purché venga trattato per quello che è.
              </p>
